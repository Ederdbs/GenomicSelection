...
* the code is optimize to run in Windows and Linux, for Windows run in parallel by default in 6 cores (can be change) and for Linux is optimize for cluster environmental, please see code in GS_Function.R for more detail about your environmental 
Enjoy the code!!!!!!
